...
class BaseRepository
{
    ...
    public function last(
        ...
        return $query->latest($createdAt)->first();
    }
    ...
    public function whereIn (
        string|array $columns = 'id', 
        string $find, 
        array $whereIn,
        bool $withTrashed = false
    ): ?object {
        $query = $this->model->select($columns)
            ->whereIn($find, $whereIn);
    ...
    /**
     * Deleta dados no banco usando where in
     *
     * @param string $column // Coluna a ser usada no where in
     * @param array|object $data // Valores a serem pesquisados
     * @return boolean
     */
    public function deleteWhereIn(string $column, array|object $data): bool 
    {
        if (empty($data)) {
            return false;
        }
